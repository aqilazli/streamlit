...
.header-title-new { font-weight: 600; color: white; font-size: 18px; flex: 1; text-align: center; }
...
<div class="wrapper">
  ...
  <div>
    <div class="label">Receiver (Detection)</div>
    <div class="phone-wrap">
      <div class="btn-vol-up"></div>
      <div class="btn-vol-down"></div>
      <div class="btn-power"></div>
    <div class="phone-frame">
      ...
      <div class="screen">
        ...
        <div class="messages" id="receiverMessages">
          <div class="date-separator">Tuesday, Jan 12</div>
        ...
        <div class="input-area">
          ...
          <input type="text" id="receiverInput" class="input-field" placeholder="Chat message">
